  ...
  const subscriptions = [
    {
      ...
      paymentHistory: [
        ...
        { date: '2024-02-15', amount: 50000, status: 'paid' },
        { date: '2024-01-15', amount: 50000, status: 'paid' }
      ]
    },
    {
      id: '2',
      agencyName: 'Habitat Plus',
      plan: 'basic',
      status: 'overdue',
      monthlyFee: 25000,
      ...
      totalPaid: 50000,
      paymentHistory: [
        { date: '2024-02-20', amount: 25000, status: 'paid' },
        { date: '2024-01-20', amount: 25000, status: 'paid' }
      ]
    },
    {
      id: '3',
